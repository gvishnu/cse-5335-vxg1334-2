...
client.connect(function(err, client){
    ...
    var query2 = client.query('CREATE TABLE flowers2(id VARCHAR(15), a VARCHAR(40), b VARCHAR(40), c VARCHAR(40), d VARCHAR(40))');
    ...
    csv_con.on("end_parsed", function(jsonObj){
        ...
        client.query('INSERT INTO flowers2(id,a,b,c,d) VALUES ($1,$2,$3,$4,$5)', 
        [jsonObj[i].id, jsonObj[i].a, jsonObj[i].b,jsonObj[i].c,jsonObj[i].d],function(err){
         ...
         prompt.get(['P_Key', 'S_key'], function(err, result) {
          ...
          var query = client.query('SELECT a FROM flowers2 WHERE id = $1',[result.P_Key]);
         ...
         query.on('end', function(result){
          ...
          var query1 = client.query('SELECT a FROM flowers2 WHERE b = $1',[result.S_key]);
